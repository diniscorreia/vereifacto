...
<div class="<?php echo 'score' . $score; ?>">
				...
				<div class="related__list column">
					...
					echo '<ul>';
						...
						foreach($author_quotes as $author_quote)
						{
							...
							if( get_field('quote_context', $author_quote->ID) ) {
								$quote_text .= get_field('quote_context', $author_quote->ID);
					 		}
							if( get_field('quote_text', $author_quote->ID) ) {
					    	$quote_text .= '' . get_field('quote_text', $author_quote->ID);
					    }
